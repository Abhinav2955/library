    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        ...
                        <p>West Bengal</p>
                        <p>India</p>
                        <p><b>Email:</b>abhinavprasad286@gmail.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2025 copyright all right reserved<br /><span>Designed with ❤️ by Abhinav Prasad</span></p>
            </div>
        </div>
    )
}
